...
public class NorthEmpireCardFactory implements CardFactory {
    ...
    public List<Card> createAllCards() {
        ...
        northEmpireCards.add(new SpyCard(UnitType.CLOSE_COMBAT,4, "Sigismund Dijkstra", FactionType.NORTH_EMPIRE,false));
        northEmpireCards.add(new UnitCard(UnitType.LONG_RANGE,5, "Sigismund Dijkstra", FactionType.NORTH_EMPIRE,false));
        ...
        northEmpireCards.add(new SpyCard(UnitType.LONG_RANGE,5, "Prince Stennis", FactionType.NORTH_EMPIRE,false));
        northEmpireCards.add(new UnitCard(UnitType.SIEGE,6, "Trebuchet", FactionType.NORTH_EMPIRE,false));
        northEmpireCards.add(new TightBondCard(UnitType.CLOSE_COMBAT,1, "Poor F*cking Infantry", FactionType.NORTH_EMPIRE,false));
        ...
        northEmpireCards.add(new TightBondCard(UnitType.CLOSE_COMBAT,1, "Catapult", FactionType.NORTH_EMPIRE,false));
        northEmpireCards.add(new UnitCard(UnitType.CLOSE_COMBAT,6, "Ballista", FactionType.NORTH_EMPIRE,false));
